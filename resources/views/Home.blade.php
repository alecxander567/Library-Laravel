...
<head>
    ...
    <body class="flex bg-gray-100">
       ...
       @if(session('success'))
        ...
        <aside x-data="{ active: 'dashboard' }" 
            @modal-closed.window="active = 'dashboard'" 
            ...
            <nav class="flex flex-col space-y-4">
                <a href="#" 
                @click.prevent="active = 'dashboard'" 
                ...
                <a href="#" 
                @click.prevent="active = 'addBook'; $dispatch('open-modal')" 
                ...
                <a href="#" 
                @click.prevent="active = 'outOfDate'" 
            ...
            <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6" 
                ...
                <form action="{{ route('books.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="available" class="w-full border px-3 py-2 rounded text-black" min="0" value="1" required>
                    </div>

                    <div class="flex justify-end space-x-3">
                        <button type="button" 
                                @click="open = false; $dispatch('modal-closed')" 
                                class="px-4 py-2 rounded bg-gray-300 hover:bg-gray-400">Cancel</button>
                        <button type="submit" 
                                class="px-4 py-2 rounded bg-blue-600 text-white hover:bg-blue-700">Add Book</button>
                    </div>
                </form>
            </div>
        </div>
                            ...
                            <tr class="hover:bg-blue-50 transition">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center space-x-2">
                                        <button class="flex items-center px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 text-base transition">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h1l1-2 3 6 4-8 2 4 3-6 1 2h1" />
                                            </svg>
                                            Borrow
                                        </button>

                                        <button class="flex items-center px-4 py-2 bg-yellow-500 text-white rounded hover:bg-yellow-600 text-base transition">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536M9 13l6-6m0 0l-6 6m6-6L9 19H5v-4l6-6z" />
                                            </svg>
                                            Edit
                                        </button>

                                        <button class="flex items-center px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600 text-base transition">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
